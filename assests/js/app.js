...
var DescriptionInputEl = document.querySelector('#Description');
...
function onAddIncomeClick() {
    addTransaction(DescriptionInputEl.value, amountInputEl.value, 'income');
}
...
function onAddExpenseClick() {
    addTransaction(DescriptionInputEl.value, amountInputEl.value, 'expense');
}
...
function render() {
    ...
    for (var i = 0; i < state.transactions.length; i++) {
        ...
        transactionEl.append(item.Description);
